    ...
    <section id="contact" className="section">
      <div className="relative overflow-hidden rounded-[1.5rem] border border-black/10 bg-[#141414] p-6 text-white shadow-glass sm:rounded-[2rem] sm:p-8 md:p-14">
        ...
        <div className="mt-8 flex flex-nowrap gap-2 sm:flex-wrap sm:gap-4">
          <a href={`mailto:${CONTACT.email}`} className="contact-cta btn-primary gap-1.5 sm:gap-2"><Mail size={15} className="sm:h-[18px] sm:w-[18px]" /> Email Me</a>
          <a href={`tel:${CONTACT.phone}`} className="contact-cta inline-flex min-h-12 items-center justify-center gap-1.5 rounded-full bg-[#34C759] px-6 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#30B650] hover:shadow-[0_18px_45px_rgba(52,199,89,0.28)] sm:gap-2"><Phone size={15} className="sm:h-[18px] sm:w-[18px]" fill="currentColor" /> Call Me</a>
          <a href={CONTACT.linkedin} className="contact-cta inline-flex min-h-12 items-center justify-center gap-1.5 rounded-full bg-[#0A66C2] px-6 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#004182] hover:shadow-[0_18px_45px_rgba(10,102,194,0.28)] sm:gap-2">
