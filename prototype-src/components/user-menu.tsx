  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem asChild>
          <Link href="/prototype/bookings">
            <LayoutDashboard className="h-4 w-4" />
            My bookings
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link href="/prototype/profile/saved">
            <Heart className="h-4 w-4" />
            Saved
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link href="/prototype/trip-planner">
        ...
        <DropdownMenuItem asChild>
          <Link href="/prototype/support">
            <LifeBuoy className="h-4 w-4" />
            Support
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link href="/prototype/profile/preferences">
