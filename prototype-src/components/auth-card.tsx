...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@prototype/components/ui/card";
...
import { isAuthDevMode } from "@prototype/lib/dev-mode";
    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        {surface === "business" ? (
          <p className="text-center text-sm text-muted-foreground">
            New business?{" "}
            <Link href="/prototype/business/onboarding" className="font-semibold text-primary hover:underline">
              Start onboarding
            </Link>
          </p>
        ) : null}
