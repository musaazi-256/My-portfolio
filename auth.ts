...
import { db } from "./prototype-src/lib/db";
import { logAuditEvent } from "./prototype-src/lib/audit";
import { isAuthDevMode } from "./prototype-src/lib/dev-mode";
...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  pages: {
    signIn: "/prototype/auth/login",
    error: "/prototype/auth/error",
  },
  basePath: "/prototype/api/auth",
  providers: [
