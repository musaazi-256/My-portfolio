...
import { GuideProfile } from "@prototype/components/guide-profile";
...
import { SimpleReservationFields } from "@prototype/components/simple-reservation-fields";
...
export default async function TourDetailPage(props: { params: Promise<{ id: string }> }) {
