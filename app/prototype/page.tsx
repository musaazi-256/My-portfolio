...
import { SearchBar } from "@prototype/components/search-bar";
import { ListingCard } from "@prototype/components/listing-card";
import { CompactListingCard } from "@prototype/components/compact-listing-card";
import { GuideCard } from "@prototype/components/guide-card";
import { HomeSection, ScrollRow } from "@prototype/components/home-section";
import { TripPlannerBanner } from "@prototype/components/trip-planner-banner";
...
import { protectedActions } from "@prototype/lib/data";
        ...
        <Container>
          <section className="py-10">
            ...
            <div className="mt-4 flex justify-end">
              <Link href="/prototype/destinations" className="flex items-center gap-1 text-sm font-semibold text-primary hover:underline">
                More details
