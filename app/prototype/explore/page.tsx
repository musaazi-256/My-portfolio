      ...
      <main>
        <Container className="pb-20">
          ...
          <div className="mt-12 mb-6 flex items-end justify-between gap-4">
            ...
            <Link href="/prototype/search" className="text-sm font-semibold text-primary hover:underline">
              Open full search
            </Link>
          </div>
          ...
          <div className="mt-12 mb-6 flex items-end justify-between gap-4">
            ...
            <Link href="/prototype/destinations" className="text-sm font-semibold text-primary hover:underline">
              All destinations
            </Link>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
